...
public class UpdateDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(526, 379, -1, -1));
 ...
 String nama = tfNama.getText();
    ...
    try {
        // koneksi ke database
        conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/DB_GYM", "postgres", "masryoo21");
        ...
        if(rowsUpdated > 0){
            ...
            this.dispose(); // tutup dialog setelah save
        } else {
